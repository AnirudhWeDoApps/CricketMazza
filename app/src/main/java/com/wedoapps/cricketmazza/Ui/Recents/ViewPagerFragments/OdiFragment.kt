...
import com.wedoapps.cricketmazza.databinding.FragmentOdiBinding

class OdiFragment : Fragment(R.layout.fragment_odi) {

    private lateinit var binding: FragmentOdiBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentOdiBinding.bind(view)
    ...
    private fun hideLoading() {
        binding.spinRecentOdiMatches.visibility = View.GONE
        binding.rvRecentOdi.visibility = View.VISIBLE
    }

    private fun showLoading() {
        binding.spinRecentOdiMatches.visibility = View.VISIBLE
        binding.rvRecentOdi.visibility = View.GONE
    }
